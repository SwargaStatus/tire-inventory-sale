...
<head>
  ...
  <style>
    ...
    .company-logo {height: 54px;background: white;border-radius: 50%;padding: 1px;filter: drop-shadow(0 0 3px rgba(0, 0, 0, 0.2));}
    ...
    .quote-modal-content {display: flex;flex-direction: column;max-height: 90vh;overflow: hidden;animation: fadeSlideIn 0.3s ease;} 
