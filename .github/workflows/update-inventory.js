...
main(); + i.reg + '</span>';
      ...
      return '<div class="card" data-manufacturer="' + i.manufacturer + '"><div class="badge badge-' + badgeType + '">' + i.disc + '% OFF</div><div class="content">' + (i.logo ? '<img src="' + i.logo + '" class="logo" alt="' + i.manufacturer + '">' : '') + '<div class="title">' + i.model + '</div><div class="details">Item: ' + i.item + '</div><div class="pricing">' + priceHtml + '</div><div class="save">Save 
