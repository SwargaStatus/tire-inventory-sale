...
main(); + i.reg + '</span>';
      ...
      return '<div class="card"><div class="badge badge-' + badgeType + '">' + i.disc + '% OFF</div><div class="content">' + (i.logo ? '<img src="' + i.logo + '" class="logo">' : '') + '<div class="title">' + i.model + '</div><div class="details">Item: ' + i.item + ' • ' + i.manufacturer + '</div><div class="pricing">' + priceHtml + '</div><div class="save">Save 
